...
import { getBrands, getWoods,addProduct, clearProduct } from '../action/products_actions';
import classes from '../Resources/css/styles.module.css';
import FileUpload from '../components/utils/form/FileUplaod';
...
class AddProducts extends Component {
    ...
    render() {
        return (
            ...
            <FileUpload
                  imagesHandler={(images)=>this.imageHandler(images)}
           ...
           <FormField
                            ...
                            change={(element) => this.updateForm(element)}
              />             
  <div className={classes.form_devider}></div>
